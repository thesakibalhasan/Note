...
export default function NotesApp() {
  ...
  // Authentication check - using imported helper
  const getCurrentTimePasswordMemo = useCallback(() => {
    return getCurrentTimePassword();
  }, []);

  const handlePasswordSubmit = useCallback(
    (e: React.FormEvent) => {
      e.preventDefault();
      const correctPassword = getCurrentTimePasswordMemo();
    ...
    [password, getCurrentTimePasswordMemo]
  );
